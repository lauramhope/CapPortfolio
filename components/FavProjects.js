...
export default function FavProjects() {
  return (
    <div className="bg-gradient-to-r from-sky-500 -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-20 lg:my-0">
          <h1 className="text-6xl lg:text-9xl max-w-lg font-bold text-gray-500 my-20 md:my-0 md:text-white dark:text-gray-200 text-center relative z-10">
            Favorite Projects
          </h1>
          <Link
            href="/projects"
