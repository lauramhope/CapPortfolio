    ...
    <div className="max-w-7xl  mx-auto px-4 py-10 md:py-20 navbar-container">
      <div className="flex  md:flex-row justify-between items-center">
        ...
        <div className="space-x-4 flex flex-row items-center">
          <a href={userData.socialLinks.instagram} className="text-base font-normal text-gray-600 dark:text-gray-300 bg-grey dark:bg-gray-800">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          >
            ...
            >
              <path
                fillRule="evenodd"
                d="M8.5 1.75a7.75 7.75 0 0 0-2.45 15.096c.39.072.533-.168.533-.374 0-.184-.007-.67-.01-1.317-2.17.473-2.63-.99-2.63-.99-.355-.9-.866-1.14-.866-1.14-.708-.483.054-.473.054-.473.782.055 1.194.8 1.194.8.694 1.19 1.82.846 2.264.646.07-.503.27-.846.492-1.042-1.72-.196-3.52-.86-3.52-3.834 0-.847.3-1.54.794-2.084-.08-.196-.343-.985.075-2.05 0 0 .65-.208 2.13.794a7.5 7.5 0 0 1 4 0c1.48-.998 2.13-.794 2.13-.794.42 1.065.16 1.854.08 2.05.495.544.794 1.237.794 2.084 0 2.982-1.81 3.636-3.535" />
            </svg>
          </a>
          <a
