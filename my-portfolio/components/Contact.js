      ...
      <div className="z-index:2 rounded-md shadow-md bg-pink-700 p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="icons-container inline-flex flex-col my-20">
              <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-500 p-4">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-telephone-fill h-4 w-4 text-blue-800"
                  viewBox="0 0 16 16"
                >
                  <path
                    fillRule="evenodd"
              ...
              <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-800 p-4">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="bi bi-envelope-fill h-4 w-4 text-blue-800"
                  viewBox="0 0 16 16"
                >
          ...
          <form className="form rounded-lg bg-white p-4 flex flex-col">
            ...
            <button
              type="submit"
              className="bg-blue-800 rounded-md w-1/2 mx-4 mt-8 py-2 text-gray-50 text-xs font-bold"
            >
              Send Message
            </button>
          </form>
